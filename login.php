...
<body>
    ...
    <div class="container">
        ...
        <div class="bg-faded p-4 my-4" style="width:40%; margin:auto">
            <hr class="divider">
            <h2 class="text-center text-lg text-uppercase my-0"> Log<strong>in</strong></h2>
            <hr class="divider">
				<?php
	// Create connection
	if(isset($_POST['submit2'])){
		$sql = "SELECT * from signup WHERE username='$_POST[user]' AND password='$_POST[pass]'";
		...
		echo "<strong style='font-size:20px;'> Your Password or Username or both are incorrect.</strong> ";
	} 
	}
	$conn->close();?>
